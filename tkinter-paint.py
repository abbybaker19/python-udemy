...
#         font_type_submenu.add_radiobutton(label="Arial", variable=self.text_font)
...
#
#         # sizes
#         size_menu = Menu(the_menu, tearoff=0)
#         size_submenu = Menu(size_menu)
#         size_submenu.add_radiobutton(label="10", variable=self.text_size, value=10)
#         size_submenu.add_radiobutton(label="12", variable=self.text_size, value=12)
#         size_submenu.add_radiobutton(label="14", variable=self.text_size, value=14)
#         size_submenu.add_radiobutton(label="16", variable=self.text_size, value=16)
...
#                                      fill=self.stroke_color.get())
#             self.draw.line([(self.x1_line_pt, self.y1_line_pt), (self.x1_line_pt, self.y2_line_pt)],
...
#             self.draw.arc([(self.x1_line_pt, self.y1_line_pt), (self.x1_line_pt, self.y2_line_pt)], start=0, end=150,
#                           fill=self.fill_color.get(), outline=self.stroke_color.get(), width=self.stroke_size.get())
#
...
#                                      width=self.stroke_size.get())
#             self.draw.ellipse([(self.x1_line_pt, self.y1_line_pt), (self.x1_line_pt, self.y2_line_pt)], start=0,
#                               end=150, fill=self.fill_color.get(), outline=self.stroke_color.get(),
#                               width=self.stroke_size.get())
#
...
#                                           fill=self.fill_color.get(), outline=self.stroke_color.get(),
#                                           width=self.stroke_size.get())
#             self.draw.rectangle([(self.x1_line_pt, self.y1_line_pt), (self.x1_line_pt, self.y2_line_pt)], start=0,
#                               end=150, fill=self.fill_color.get(), outline=self.stroke_color.get(),
#                               width=self.stroke_size.get())
#
...
#                 event.widget.create_text(self.x1_line_pt, self.y1_line_pt, fill=self.fill_color.get(), font=text_font,
#                                          text=user_text)
#
